...
\vspace{10mm}
		...
		\begin{figure}[!ht]
			\centering
			\subfloat[Funcionamiento de un sensor de posición]{%
				\includegraphics[width=0.6\textwidth]{Velocidadsensoresdeposición.jpg}%
				\label{fig:sensores}
		...
		\end{figure}
				...
				\begin{figure}[h]
					\centering
					\subfloat[Diagrama esquemático de un tacómetro]{%
						\includegraphics[width=0.7\textwidth]{Tacómetro.jpg}%
						\label{fig:Tacómetro}
						\cite{saha2010robotics}
					}
					\hfill
			...
			\begin{figure}[h]
				\centering
				\subfloat[Principio de un sensor de efecto Hall]{%
					\includegraphics[width=0.4\textwidth]{Hall.jpg}%
					\label{fig:Hall}
					\cite{Hall}
				}
				\hspace{0.5cm} % Espacio entre imágenes (ajusta el valor si es necesario)
				\subfloat[Funcionamiento del efecto Hall]{%
					\includegraphics[width=0.4\textwidth]{HallFuncionamiento.jpg}%
					\label{fig:EfectoHall}
					\cite{EfectoHall}
				}
				\caption{Ejemplo de interruptor de efecto Hall y su funcionamiento.}
			...
			\end{enumerate}
				...
				\subfloat[Aceleración]{%
					\includegraphics[width=0.7\textwidth]{Aceleración.jpg}%
			...
			\begin{enumerate}
				...
				\begin{figure}[h]
					\centering
					\subfloat[Galgas extensométricas]{%
						\includegraphics[width=0.4\textwidth]{Galgas.jpg}%
						\label{fig:Galgas}
					}
					\hspace{0.5cm} % Espacio entre imágenes (ajusta el valor si es necesario)
					\subfloat[Funcionamiento de las galgas]{%
						\includegraphics[width=0.4\textwidth]{GalgasFuncionamiento.jpg}%
						\label{fig:GalgasFuncionamiento}
					}
				...
				\begin{figure}[h]
					...
					\subfloat[Interruptor de efecto Hall]{%
						\includegraphics[width=0.45\textwidth]{Hall.jpg}%
						\label{fig:Interruptor de Efecto Hall}
					}
					\hspace{0.5cm} % Espacio entre imágenes (ajusta el valor si es necesario)
					\subfloat[Funcionamiento del efecto Hall]{%
						\includegraphics[width=0.45\textwidth]{HallFuncionamiento.jpg}%
						\label{fig:EfectoHall}
					}
				...
				\item Interruptores piezoeléctricos: Un material piezoeléctrico presenta un fenómeno conocido como efecto piezoeléctrico. Este efecto señala que cuando cristales elásticos asimétricos se deforman mediante una fuerza, se desarrollará un potencial eléctrico dentro de la red cristalina deformada. \cite{saha2010robotics}
					...
					\begin{figure}[h]
					\centering
					\subfloat[Interruptor Piezoeléctrico]{%
						\includegraphics[width=0.4\textwidth]{InterruptoresPiezoeléctricos.jpg}%
						\label{fig:Piezoelectrico}
					}
					\hspace{0.5cm} % Espacio entre imágenes (ajusta el valor si es necesario)
					\subfloat[Funcionamiento de interruptor piezoeléctrico]{%
					\includegraphics[width=0.4\textwidth]{PiezoelectricoFuncionamiento.jpg}%
	...
	\subsection{Sensores Externos}
	 \begin{enumerate}
		...
		\begin{enumerate}
			...
			\begin{figure}[h]
				\centering
				\subfloat[Interruptores de Limite]{%
					\includegraphics[width=0.24\textwidth]{InterruptoresdeLimite.jpg}%
					\label{fig:Interruptores de Limite}
				}
				\hspace{0.5cm} % Espacio entre imágenes (ajusta el valor si es necesario)
				\subfloat[Funcionamiento de interruptor piezoeléctrico]{%
				\includegraphics[width=0.7\textwidth]{LimiteFuncion.jpg}%
				\label{fig:FuncionamientoPiezoeléctrico}
				}
			...
			\begin{figure}[h]
				\centering
				\subfloat[Interruptor neumático]{%
					\includegraphics[width=0.19\textwidth]{Neumático.jpg}%
					\label{fig:Interruptor neumático}
					\cite{InterruptorNeumático}
				}
				\hspace{0.5cm} % Espacio entre imágenes (ajusta el valor si es necesario)
				\subfloat[Funcionamiento de interruptor neumático]{%
					\includegraphics[width=0.22\textwidth]{NeumaticoFuncionamiento.jpg}%
					\label{fig:NeumaticoFuncionamiento}
						\cite{NeumaticoFuncion}
				}
			...
			Siendo eliminado el campo eléctrico, la carga se liberará y cuando se aplique presión, la carga se reorganizará para provocar la carga deseada. Con estos sensores no debe exceder la temperatura máxima, mejor conocida como «temperatura de Curie», ya que por encima de la temperatura máxima, las cargas volverán a su estado inicial en un estado caótico, y estas cargas no se generarán. \cite{SensoresPiezoelectricos}
					...
					\begin{figure}[h]
					\centering
					\subfloat[Sensor piezoeléctrico]{%
					...
					\subfloat[Funcionamiento de sensor piezoeléctrico]{%
						\includegraphics[width=0.25\textwidth]{SensorFuncion.jpg}%
						\label{fig:NeumaticoFuncionamiento}
							\cite{SensorFuncion}
					}
			...
			\begin{figure}[h]
				\centering
				\subfloat[Transductor de presión]{%
					\includegraphics[width=0.25\textwidth]{Presión.jpg}%
					\label{fig:Presión}
					\cite{Presión}
				}
				\hfill
		...
		\begin{enumerate}
			...
			\begin{figure}[h]
				...
				\subfloat[Sensor de proximidad]{%
					\includegraphics[width=0.30\textwidth]{Prox.jpg}%
			...
			\begin{figure}[h]
				...
				\subfloat[Sensor de efecto Hall]{%
					\includegraphics[width=0.5\textwidth]{SHall.jpg}%
			...
			\begin{figure}[h]
				\centering
				\subfloat[Funcionamiento del sensor de microondas]{%
					\includegraphics[width=0.4\textwidth]{sensor_microondas.jpg}%
			...
			\begin{figure}[h]
				\centering
				\subfloat[Funcionamiento del sensores ultrasónico]{%
					\includegraphics[width=0.30\textwidth]{sensor_ultrasonica.png}%
					\label{fig:funcionamiento del sensores ultrasónico}
					\cite{microsonic}
				}
				\hfill
			\end{figure}
			...
			\begin{figure}[h]
				\centering
				\subfloat[Funcionamiento del sensor láser]{%
					\includegraphics[width=0.30\textwidth]{Sensor_Laser.jpg}%
					\label{fig:Funcionamiento del sensor láser}
					\cite{OMCH}
				}
				\hfill
			\end{figure}
			...
			\begin{figure}[h]
				\centering
				\subfloat[funcionamiento del sensor de visión]{%
					\includegraphics[width=0.30\textwidth]{sensor_vision.jpg}%
					\label{fig:funcionamiento del sensor de visión}
					\cite{COGNEX}
				}
				\hfill
			\end{figure}
	...
	\subsection{Otros}
		...
		\begin{figure}[h]
			\centering
			\subfloat[Giroscopio]{%
				\includegraphics[width=0.35\textwidth]{Giroscopio.jpg}%
				\label{fig:Giroscopio}
				\cite{GiroscopioImagen}
			}
			\hfill
		\end{figure}	
		...
		\begin{figure}[h]
			\centering
			\subfloat[Acelerómetro]{%
				\includegraphics[width=0.42\textwidth]{Acelerómetro.jpg}%
				\label{fig:Acelerómetro}
				\cite{Acelerómetro}
			}
			\hfill
		\end{figure}	
		...
		\begin{figure}[h]
			\centering
			\subfloat[Magnetómetro]{%
				\includegraphics[width=0.45\textwidth]{Magnetómetro.jpg}%
				\label{fig:Magnetómetro}
				\cite{Magnetómetro}
			}
			\hfill
		\end{figure}	
		...
		\begin{figure}[h]
			\centering
			\subfloat[LiDAR vs. fotogrametría]{%
				\includegraphics[width=0.47\textwidth]{LiDARImagen.jpg}%
				\label{fig:LiDAR}
				\cite{LiDARImagen}
			}
			\hfill
