...
\vspace{10mm}
		...
		\end{figure}
			...
			\begin{figure}[h]
				...
				\subfloat[Principio de un sensor de efecto Hall]{%
					\includegraphics[width=0.7\textwidth]{Hall.jpg}%
					\label{fig:Hall}
					\cite{Hall}
				}
				\hfill
			...
			\begin{enumerate}
				...
				\begin{figure}[h]
					...
					\subfloat[Galgas extensométricas]{%
						\includegraphics[width=0.35\textwidth]{Galgas.jpg}%
						\label{fig:Galgas}
					}
					\hspace{0.5cm} % Espacio entre imágenes (ajusta el valor si es necesario)
					\subfloat[Funcionamiento de las galgas]{%
						\includegraphics[width=0.35\textwidth]{GalgasFuncionamiento.jpg}%
		...
		\begin{enumerate}
			...
			\begin{figure}[h]
				...
				\subfloat[Interruptor neumático]{%
					\includegraphics[width=0.25\textwidth]{Neumático.jpg}%
		...
		\begin{enumerate}
			...
			\begin{figure}[h]
				...
				\subfloat[Sensor de efecto Hall]{%
					\includegraphics[width=0.40\textwidth]{SHall.jpg}%
			...
			\begin{figure}[h]
				...
				\subfloat[Funcionamiento del sensor de microondas]{%
					\includegraphics[width=0.30\textwidth]{sensor_microondas.jpg}%
	...
	\subsection{Otros}
		...
		\begin{figure}[h]
			\centering
			\subfloat[Giroscopio]{%
				\includegraphics[width=0.3\textwidth]{Giroscopio.jpg}%
		...
		\begin{figure}[h]
			...
			\subfloat[Acelerómetro]{%
				\includegraphics[width=0.38\textwidth]{Acelerómetro.jpg}%
		...
		\begin{figure}[h]
			...
			\subfloat[Magnetómetro]{%
				\includegraphics[width=0.3\textwidth]{Magnetómetro.jpg}%
		...
		\begin{figure}[h]
			...
			\subfloat[LiDAR vs. fotogrametría]{%
				\includegraphics[width=0.38\textwidth]{LiDARImagen.jpg}%
				\label{fig:LiDAR}
				\cite{LiDARImagen}
			}
			\hfill
