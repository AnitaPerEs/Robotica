			...
			\begin{enumerate}
				...
				\item Interruptores piezoeléctricos: Un material piezoeléctrico presenta un fenómeno conocido como efecto piezoeléctrico. Este efecto señala que cuando cristales elásticos asimétricos se deforman mediante una fuerza, se desarrollará un potencial eléctrico dentro de la red cristalina deformada. \cite{saha2010robotics}\\
					...
					\subfloat[Interruptor Piezoeléctrico]{%
						\includegraphics[width=0.25\textwidth]{InterruptoresPiezoeléctricos.jpg}%
						\label{fig:Piezoelectrico}
						\cite{InterruptorPiezoeléctrico}
					}
					\hfill
				\end{figure}
		...
		\begin{enumerate}
			...
			\begin{figure}[h]
				...
				\subfloat[Interruptores de Limite]{%
					\includegraphics[width=0.25\textwidth]{InterruptoresdeLimite.jpg}%
					\label{fig:Interruptores de Limite}
					\cite{InterruptoresdeLimite}
				}
				\hfill
			\end{figure}
